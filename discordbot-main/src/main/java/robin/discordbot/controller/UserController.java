...
public class UserController {
    ...
    @PostMapping("/login")
    public Result<String> login(@Pattern(regexp = "^\\S{3,16}$") @ RequestParam String username, @RequestParam  @Pattern(regexp = "^\\S{5,16}$") String password) {
        //根据用户名查询用户
        ...
        if (Md5Util.getMD5String(password).equals(loginUser.getPassword())) {
            ...
            if (username.equals("徐晨阳2025")){
                loginUser.setCredit(loginUser.getCredit() + 2);
